...
| ---------------- | --------------------------------- | ---------------------------------------- |
| VCC              | แบตเตอรี่ 12V (+)                 | ต่อขั้วบวกจากแหล่งจ่ายไฟภายนอก           |
| GND              | แบตเตอรี่ 12V (-) และ Arduino GND | **ต้องต่อ "กราวด์ร่วม" (Common Ground)** |
| IN1              | Arduino D2                        | ควบคุมปั๊มน้ำ                            |
| IN2              | Arduino D3                        | ควบคุมพัดลม                              |
| IN3              | Arduino D4                        | (สำรอง)                                  |
| IN4              | Arduino D5                        | (สำรอง)                                  |
